                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="{{route('register')}}"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Interview Task</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Welcome you have successfully installed the project. Please register to see the functionalities. Thank You!
                                </p>
                            </div>
